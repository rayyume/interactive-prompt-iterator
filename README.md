...
<table>
  <tr>
    <td width="50%">
      <h4>📝 内容创作场景</h4>
      <p>博客文章、技术文档、营销文案等不同内容类型的提示词生成</p>
    </td>
    <td width="50%">
      <h4>💼 专业工作场景</h4>
      <p>数据分析报告、项目方案、会议纪要等商务场景的提示词优化</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h4>🎓 学术研究场景</h4>
      <p>论文摘要、文献综述、研究计划等学术场景的提示词构建</p>
    </td>
    <td width="50%">
      <h4>🎨 创意设计场景</h4>
      <p>UI设计需求、品牌故事、创意策划等设计场景的提示词迭代</p>
    </td>
  </tr>
</table>

> 💡 **提示**: 支持多种场景的智能提示词优化，通过交互式表单快速生成高质量 Prompt
